...
def replace_params(obj, params,json_file_path):
    ...
    elif "config_write_dremio_cloud.json" in json_file_path:
        target = dremio_cloner[1]['target']
        target[0]['endpoint'] = params['endpoint']
        target[1]['username'] = params['username']
        target[2]['password'] = params['password']
        target[6]['dremio_cloud_org_id'] = params['dremio_cloud_org_id']
        target[7]['dremio_cloud_project_id'] = params['dremio_cloud_project_id'] 
